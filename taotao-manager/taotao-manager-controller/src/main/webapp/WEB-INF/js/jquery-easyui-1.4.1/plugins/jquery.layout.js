...
(function ($) {
    ...
    function _17(_18, _19, el) {
        ...
        if (pp.panel("options").split) {
            ...
            _1f.resizable($.extend({}, {
                handles: _20, onStartResize: function (e) {
                    _1 = true;
    ...
    function _2b(_2c, _2d, _2e) {
        ...
        function _34() {
            ...
            if (_2d == "east") {
                ...
                return {
                    resizeC: {width: _3a},
                    expand: {left: cc.width() - _39},
                    expandP: {top: _37.top, left: cc.width() - _38, width: _38, height: _37.height},
                    collapse: {left: cc.width(), top: _37.top, height: _37.height}
                };
            } else {
                if (_2d == "west") {
                    var _39 = p.panel("panel")._outerWidth();
                    ...
                    return {
                        resizeC: {width: _3a, left: _38 - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _37.top, width: _38, height: _37.height},
                        collapse: {left: -_39, top: _37.top, height: _37.height}
                    };
                } else {
                    if (_2d == "north") {
                        ...
                        _2f.east.add(_2f.west).add(_2f.expandEast).add(_2f.expandWest).panel("resize", {
                            top: _38 - 1,
                            height: hh
                        });
                        return {
                            resizeC: {top: _38 - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _38},
                            collapse: {top: -_3b, width: cc.width()}
                        };
                    } else {
                        if (_2d == "south") {
                            var _3b = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _3b},
                                expandP: {top: cc.height() - _38, left: 0, width: cc.width(), height: _38},
    ...
    function _3c(_3d, _3e) {
        ...
        function _43() {
            ...
            if (_3e == "east" && _3f.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _44.top, height: _44.height},
                    expand: {left: cc.width() - p.panel("panel")._outerWidth()}
                };
            } else {
                if (_3e == "west" && _3f.expandWest) {
                    return {
                        collapse: {left: -p.panel("panel")._outerWidth(), top: _44.top, height: _44.height},
                        expand: {left: 0}
                    };
                } else {

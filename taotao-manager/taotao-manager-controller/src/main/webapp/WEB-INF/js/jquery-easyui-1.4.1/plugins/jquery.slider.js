...
(function ($) {
    ...
    $.fn.slider = function (_3b, _3c) {
        ...
        return this.each(function () {
            ...
            if (_3d) {
                ...
                _3d = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _3b),
                    slider: _1(this)
                });
    ...
    $.fn.slider.parseOptions = function (_43) {
        var t = $(_43);
        return $.extend({}, $.parser.parseOptions(_43, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            min: "number",
            max: "number",

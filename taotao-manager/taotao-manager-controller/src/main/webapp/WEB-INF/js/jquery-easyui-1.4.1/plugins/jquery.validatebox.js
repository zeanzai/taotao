...
(function ($) {
    ...
    $.fn.validatebox.parseOptions = function (_39) {
        var t = $(_39);
        return $.extend({}, $.parser.parseOptions(_39, ["validType", "missingMessage", "invalidMessage", "tipPosition", {
            delay: "number",
            deltaX: "number"
        }]), {
    ...
    $.fn.validatebox.defaults = {
        ...
        novalidate: false,
        events: {
            focus: _b, blur: _10, mouseenter: _14, mouseleave: _17, click: function (e) {
                var t = $(e.data.target);
                if (!t.is(":focus")) {
                    t.trigger("focus");
                }
